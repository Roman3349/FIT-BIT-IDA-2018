...
x \in U \setminus (X \cup Y) \Rightarrow
x \in U \wedge x \not\in (X \cup Y) \Rightarrow \\ \Rightarrow
x \in U \wedge (x \not\in X \vee x \not\in Y) \Rightarrow
...
\begin{eqnarray*}
R_{1} = \lbrace (1, 2), (2, 3), (3, 1) \rbrace \\
\tau(R_{1}) = \lbrace (1, 2), (2, 3), (3, 1), (1, 3), (2,1), (1, 1), (3, 3) \rbrace \\
\sigma(\tau(R_{1})) = \lbrace (1,2), (2, 1), (2, 3), (2, 2), (3, 1), (1, 3), (1, 1), (3, 3) \rbrace \\
\sigma(R_{1}) = \lbrace (1, 2), (2, 3), (3, 1), (2, 1), (3, 2), (1, 3) \rbrace \\
\tau(\sigma(R_{1})) = \lbrace (1, 1), (2, 2), (3, 3), (1, 2), (2, 3), (3, 1), (2, 1), (3, 2), (1, 3) \rbrace \\
\sigma(\tau(R_{1})) \neq \tau(\sigma(R_{1}))
\end{eqnarray*}
...
\rho(\tau(R_{1})) =
\rho(R_{1} \circ R_{1}) =
(R_{1} \circ R_{1}) \cup X =
(R_{1} \cup \Delta X) \circ (R_{1} \cup \Delta X) = \\ =
\rho(R_{1}) \circ \rho(R_{1}) =
\tau(\rho(R_{1}))
\end{eqnarray*}
